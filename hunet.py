...
class HUNet(nn.Module):
    def __init__(self, in_channels, start_iblock_channels=32, dropout=0.3):
        ...
        # 12x256x256 input - crop from image volume (assuming in_channels=12)
...
class HUNet2Class(nn.Module):
    def __init__(self, in_channels, start_iblock_channels=32, dropout=0.3):
        super(HUNet2Class, self).__init__()
        ...
        self.class1_final_conv2d = nn.Conv2d(final_conv_in_channels, in_channels, (1, 1))
        self.class2_final_conv2d = nn.Conv2d(final_conv_in_channels, in_channels, (1, 1))
    ...
    def forward(self, x_in):
        ...
        out1 = self.class1_final_conv2d(up1)
        out2 = self.class2_final_conv2d(up1)
